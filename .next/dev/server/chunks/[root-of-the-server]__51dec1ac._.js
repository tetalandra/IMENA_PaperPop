...
;
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://localhost:27017/paperpop';
...
async function POST(req) {
    try {
        ...
        // Create user
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            name,
            email,
            password
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__51dec1ac._.js.map